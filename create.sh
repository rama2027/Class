...
aws cloudformation create-stack --stack-name $stackname --template-url http://s3.amazonaws.com/cft-rama/iam.json --stack-name $stackname --on-failure DELETE --region $Region
if [[ $? -eq 0 ]]
then
